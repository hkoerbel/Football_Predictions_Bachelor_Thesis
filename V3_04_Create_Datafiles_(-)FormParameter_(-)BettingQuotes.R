...
#4) Create data files ready for the models NOT leveraging a form parameter nor
# betting odds.
...
wanted_cols <- c("HomeTeam", "AwayTeam", "FTR", "Date")
...
# seasons 2017/18 - 2024/25 and the columns "Date", "HomeTeam", "AwayTeam, "FTR"
...
make_lagged_df <- function(df) {
  ...
  #the original df (only keeping the key-columns and FTR) and join the lagged
  #home and away stats.
  df %>%
