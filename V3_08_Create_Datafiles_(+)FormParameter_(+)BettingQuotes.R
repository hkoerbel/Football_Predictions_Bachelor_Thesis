...
#This script is a copy of "V3_07_Create_Datafiles_(+)FormParameter_(-)BettingQuotes.R".
#It is only altered minimally, such that the output files have the betting odds as an 
#additional column This is not the most elegant way, but the easiest and fastest.
